package demo.docker.repository;

import demo.docker.EsempioDockerApp;
import demo.docker.config.Constants;
import demo.docker.config.audit.AuditEventConverter;
import demo.docker.domain.PersistentAuditEvent;
...
import static demo.docker.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
